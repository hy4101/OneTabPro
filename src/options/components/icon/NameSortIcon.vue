<template>
  <svg t="1682320758593" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
       p-id="2783" :width="size" :height="size">
    <path
